 ...
 */
public class ZaixiandayiVO  implements Serializable {
	...
	public void setDayiriqi(Date dayiriqi) {
		this.dayiriqi = dayiriqi;
	}
	
	/**
	 * 获取：答疑日期
	 */
	public Date getDayiriqi() {
		return dayiriqi;
	}
