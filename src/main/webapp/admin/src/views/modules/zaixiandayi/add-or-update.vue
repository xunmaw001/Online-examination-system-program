          ...
          <el-form-item class="input" label="类型" prop="leixing">
              <el-input v-model="ruleForm.leixing" 
                placeholder="类型" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="答疑日期" prop="dayiriqi">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.dayiriqi" 
                type="date"
                placeholder="答疑日期">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.dayiriqi" label="答疑日期" prop="dayiriqi">
              <el-input v-model="ruleForm.dayiriqi" 
                placeholder="答疑日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="教师姓名" prop="jiaoshixingming">
              <el-input v-model="ruleForm.jiaoshixingming" 
                placeholder="教师姓名" readonly></el-input>
                                                    ...
                                                    <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="答疑内容" prop="dayineirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="答疑内容"
                  v-model="ruleForm.dayineirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dayineirong" label="答疑内容" prop="dayineirong">
                    <span>{{ruleForm.dayineirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.leixing = true;
            continue;
	            	            ...
	            	            if(o=='dayineirong'){
            this.ruleForm.dayineirong = obj[o];
	    this.ro.dayineirong = true;
            continue;
          }
	            	            if(o=='dayiriqi'){
            this.ruleForm.dayiriqi = obj[o];
	    this.ro.dayiriqi = true;
            continue;
          }
	            	            if(o=='xuehao'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `zaixiandayi/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zaixiandayiCrossAddOrUpdateFlag = false;
                  this.parent.search();
